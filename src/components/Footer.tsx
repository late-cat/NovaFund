      ...
      <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col items-center md:items-end gap-3">
          <div className="flex gap-4 text-gray-500">
            <a href="https://github.com/late-cat/NovaFund" target="_blank" rel="noopener noreferrer" aria-label="GitHub Repository" className="hover:text-orange-500 transition-colors">
            ...
            <a href="https://twitter.com/stellarorg" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="hover:text-orange-500 transition-colors">
            ...
            <a href="https://stellar.org" target="_blank" rel="noopener noreferrer" aria-label="Stellar Website" className="hover:text-orange-500 transition-colors">
