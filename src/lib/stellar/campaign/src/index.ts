...
export interface Client {
   ...
   */
  init: ({creator, token, goal, deadline}: {creator: string, token: string, goal: i128, deadline: u64}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAADJJbml0aWFsaXplcyB0aGUgY2FtcGFpZ24uIENhbiBvbmx5IGJlIGNhbGxlZCBvbmNlLgAAAAAABGluaXQAAAAEAAAAAAAAAAdjcmVhdG9yAAAAABMAAAAAAAAABXRva2VuAAAAAAAAEwAAAAAAAAAEZ29hbAAAAAsAAAAAAAAACGRlYWRsaW5lAAAABgAAAAA=",
